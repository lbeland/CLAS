...
BenchSink::BenchSink() : IProcessor(PRIORITY_HIGH)
{
...
void BenchSink::Prepare(GlobalContext &context)
{
...
void BenchSink::Preprocess(ProcessingContext &context)
{
    packet_count_ = 0;
}

void BenchSink::Process(ProcessingContext &context)
{
...
void BenchSink::Postprocess(ProcessingContext &context)
{
