...
ChannelSelection::ChannelSelection() : IProcessor(PRIORITY_HIGH)
{
...
void ChannelSelection::CreatePorts()
{
...
void ChannelSelection::CompleteStreamInfo()
{
...
void ChannelSelection::Prepare(GlobalContext &context)
{
...
void ChannelSelection::Preprocess(ProcessingContext &context)
{
...
void ChannelSelection::Process(ProcessingContext &context)
{
