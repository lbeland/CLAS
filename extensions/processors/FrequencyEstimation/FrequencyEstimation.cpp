...
#include "FrequencyEstimation.hpp"
...
FrequencyEstimation::FrequencyEstimation() : IProcessor(PRIORITY_HIGH)
{
...
void FrequencyEstimation::CreatePorts()
{
...
void FrequencyEstimation::CompleteStreamInfo()
{
...
void FrequencyEstimation::Prepare(GlobalContext &context)
{
...
void FrequencyEstimation::Process(ProcessingContext &context)
{
...
void FrequencyEstimation::Unprepare(GlobalContext &context)
{
    {
        std::lock_guard<std::mutex> lock(dsp::fftw::planner_mutex);
...
REGISTERPROCESSOR(FrequencyEstimation);
