...
SimulatedSource::SimulatedSource() : IProcessor(PRIORITY_HIGH)
{
...
void SimulatedSource::CreatePorts()
{
...
void SimulatedSource::CompleteStreamInfo()
{
...
void SimulatedSource::Preprocess(ProcessingContext &context)
{
    packet_count_ = 0;
}

void SimulatedSource::Process(ProcessingContext &context)
{
...
void SimulatedSource::Postprocess(ProcessingContext &context)
{
    LOG(INFO) << name() << ": Total messages sent: " << packet_count_;
}

REGISTERPROCESSOR(SimulatedSource);
