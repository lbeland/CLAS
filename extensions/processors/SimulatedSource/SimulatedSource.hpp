...
protected:
    ...
    options::Double mod_period_s_{5.0};
    options::Double phase_jump_angle_{M_PI};
    options::Double freq_step_size_{1.0};
    options::Double chirp_slope_{0.0};

    options::String noise_color_{"white"};
    options::Double snr_db_{20.0};
    options::Double noise_band_hz_{4.0};
    options::Int noise_seed_{-1};
    options::Double burst_on_s_{1.0};
    options::Double burst_off_s_{0.0};
